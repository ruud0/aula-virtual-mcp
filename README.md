...
1. Ask Claude to `authenticate` — a browser window opens for SSO login
...
Built for Universidad de Navarra's Aula Virtual, but the Blackboard Learn API is standard — change `BASE_URL` to point at any Blackboard Ultra instance.
